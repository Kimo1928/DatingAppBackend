...
namespace DatingAppWebApi.Controllers
{
     ...
     [Authorize]
    public class UsersController(IUnitOfWork unitOfWork,IMapper mapper,IPhotoService photoService): BaseController
    {
        ...
        public async Task<IActionResult> GetAllUsers([FromQuery] UserParams userParams)
            ...
            var users = await unitOfWork.UserRepository.GetAllUsersAsync(userParams);
        ...
        {
            var photos = await unitOfWork.UserRepository.GetUserPhotos(id);
            return Ok(photos);
        }

        public async Task<IActionResult> UpdateUser(UserUpdateDTO userUpdateDTO) {
            var userId=User.GetUserId();
            var user = await unitOfWork.UserRepository.GetUserForUpdate(userId);
        ...
        public async Task<IActionResult> uploadPhoto([FromForm]IFormFile file) {
            var user = await unitOfWork.UserRepository.GetUserForUpdate(User.GetUserId());
